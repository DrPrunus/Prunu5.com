...
const PROJECTS: Project[] = [
  {
    id: '4',
    title: {
      zh: '404 Princess Not Found',
      en: '404 Princess Not Found',
      ja: '404 Princess Not Found'
    },
    category: 'PC',
    description: {
  ...
  },
  {
    ...
    title: {
      zh: '《深岩银河》赛季通行证系统拆解案',
      en: '"Deep Rock Galactic" Season Pass System Analysis',
      ja: '『Deep Rock Galactic』シーズンパスシステム分析'
    },
    category: '游戏拆解',
    description: {
  ...
  },
  {
    ...
    title: {
      zh: '《光·遇》社交系统拆解案',
      en: '"Sky: Children of the Light" Social System Analysis',
      ja: '『Sky 星を紡ぐ子どもたち』ソーシャルシステム分析'
    },
    category: '游戏拆解',
    description: {
  ...
  },
  {
    ...
    title: {
      zh: '《杀戮尖塔》核心模块拆解',
      en: '"Slay the Spire" Core Module Analysis',
      ja: '『Slay the Spire』コアモジュール分析'
    },
    category: '游戏拆解',
    description: {
