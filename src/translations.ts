...
export const translations = {
  ...
  ja: {
    ...
    hero: {
      ...
      subtitleMusic: 'メロディを通じて情緒的な雰囲気を作り出し、仮想空間に魂を吹き込むことに情熱を注いでいます。',
      btnRepo: 'プロジェクトを見る',
      btnContact: '連絡',
      btnMusic: '音楽主ページ',
    },
    sections: {
      ...
      about: {
        title: '私について',
        subtitle: '',
        p1: '私はデザイン、技术実装、プロジェクト管理の交差点で活跃する、プロジェクト指向のゲーム开発者です。コードの精密さを追求しつつ、プレイヤー体验がもたらす感情的なインパクトを最も大切にしています。',
        p2: '开発以外では、热心な音楽ファンでありピクセルアーティストでもあります。FL Studioでインスピレーションを形にし、Asepriteで想像力豊かなアイデアを描き出すのが日课です。多角的な感覚体验こそがゲームの魂を形作ると信じています。',
        p3: '单独のロジック开発から复雑なワークフロー计画まで、あらゆるプロジェクトにフルスタックの思考で取り組みます。现在、コンセプトスケッチを确かなデジタルリアリティへと変えるため、エンジンを超えた开発の可能性を常に模索しています。',
        tech: '技术スタック',
        disciplines: '専门分野',
      },
      pipeline: {
